...
WizardSelectDir=Select Tomcat Webapps Location
SelectDirDesc=Where should Weave be installed?
SelectDirLabel3=Setup will install [name] into the following folder.
SelectDirBrowseLabel=Select the location of your Tomcat webapps folder by clicking Browse.
